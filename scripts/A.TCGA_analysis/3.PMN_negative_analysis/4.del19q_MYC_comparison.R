...
myc_expr <- SummarizedExperiment::assay(dds_norm[SummarizedExperiment::rowData(dds_norm)$gene_name == "MYC", ])
...
ggsave("output/20.MYC_expr_by_19q_del.pdf", ggarrange(g, g2, nrow = 2), width = 5, height = 8)
