...
ggsave("output/17.PMNneg_alter_MYC_expr.pdf", g, width = 6, height = 7)
...
ggsave("output/18.alter_class_survival.pdf", g_surv, width = 8, height = 15)
...
ggsave("output/19.all_classes_by_grade.pdf", p, width = 6, height = 6)
...
ggsave("output/20.PMNneg_classes_by_grade.pdf", p2, width = 6, height = 6)
...
ggsave("output/21.alter_class_burden.pdf", g_comb2, width = 16, height = 10)
